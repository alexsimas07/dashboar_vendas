...
with aba3:
    ...
    with coluna1:
        ...
        fig_receita_vendedores.update_layout(showlegend=False,yaxis_title='Vendedores',xaxis_title='Receita')
    ...
    with coluna2:
        ...
        fig_vendas_vendedores.update_layout(showlegend=False,yaxis_title='Vendedores',xaxis_title='Quantidade de vendas')
